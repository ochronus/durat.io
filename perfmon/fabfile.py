"""
Starter fabfile for deploying the perfmon project.
...
# CHANGEME
env.hosts = ['user@perfmon.example.com']
env.code_dir = '/srv/www/perfmon'
env.project_dir = '/srv/www/perfmon/perfmon'
env.static_root = '/srv/www/perfmon/static/'
env.virtualenv = '/srv/www/perfmon/.virtualenv'
env.code_repo = 'git@github.com:user/perfmon.git'
env.django_settings_module = 'perfmon.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/perfmon/wsgi.py" % env.code_dir)
